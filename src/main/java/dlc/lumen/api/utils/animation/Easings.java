...
public final class Easings {
   ...
   public static final Easing BOUNCE_OUT = x -> {
      ...
      double var4 = 2.75;
      if (x < 1.0 / var4) {
         return var2 * Math.pow(x, 2.0);
      } else if (x < 2.0 / var4) {
         return var2 * Math.pow(x - 1.5 / var4, 2.0) + 0.75;
      } else {
         return x < 2.5 / var4 ? var2 * Math.pow(x - 2.25 / var4, 2.0) + 0.9375 : var2 * Math.pow(x - 2.625 / var4, 2.0) + 0.984375;
      }
   };
